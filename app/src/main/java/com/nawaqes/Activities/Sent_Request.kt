...
import kotlinx.android.synthetic.main.activity_sent__message.Img_ShowCamera
import kotlinx.android.synthetic.main.activity_sent__message.progressBarLogin
...
class Sent_Request : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sent__request)
        getData()
        Choose_Image()
        Send_Request()
    ...
    public override fun onActivityResult(requestCode:Int, resultCode:Int, data: Intent?) {
        ...
        if (requestCode == GALLERY)
        {
            if (data != null)
            {
                ...
                val filePath = getRealPathFromURIPath(contentURI!!, this@Sent_Request)
                file = File(filePath)
