...
class Slider_Adapter (private val context: Context, private val imageModelArrayList: ArrayList<Banners_Response.Data>) : PagerAdapter() {
    ...
    override fun instantiateItem(view: ViewGroup, position: Int): Any {
        ...
        val imageView = imageLayout
            .findViewById(R.id.viewPagerItem_image1) as ImageView
